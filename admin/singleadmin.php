				...
				<div class="row">
					...
					<div id="main" class="col-md-10">
						...
						<div class="row">
							...
							<hr>
							<table align="center" width="400px" height="600px" border="1">
								<tr>
									<td colspan="2" align="center"><img src="../upload/admin_image/<?php echo $result['admin_image'] ?>" width="200px" height="220px"></td>
								</tr> 
								<tr>
									<td>Name</td>
