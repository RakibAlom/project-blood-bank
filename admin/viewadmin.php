						...
						<div class="row">
							...
							<table class="table table-striped table-hover">
								...
								<tr>
									...
									<td><a href="singleadmin.php?=<?php echo $result['admin_id']; ?>"><?php echo $result['admin_name'] ?></a></td>
									<td><?php echo $result['admin_blood'] ?></td>
									
									<td><?php echo $result['admin_gender'] ?></td>
									<td><?php echo $result['admin_birth'] ?></td>
									<td><?php echo $result['admin_phone'] ?></td>
									<td><?php echo $result['admin_address'] ?></td>
									<td><?php echo $result['admin_email'] ?></td>
									<td><img src="../upload/admin_image/<?php echo $result['admin_image']; ?>" width="50px" height="50px"></td>
									<td>
										<a href="editadmin.php?id=<?php echo $result['admin_id']; ?>"><button class="btn btn-primary btn-sm">edit</button></a>
										<a href="deleteadmin.php?id=<?php echo $result['admin_id']; ?>"><button class="btn btn-danger btn-sm">delete</button></a>
									</td>
								</tr>
								<?php } ?>
							</table>
