						...
						<div class="row">
							...
							<hr>
								...
								if (isset($_POST['search'])) {
									...
									$sql = "SELECT * FROM blood_donator WHERE donar_blood LIKE '%$searchdata%'";
									$count = 1;
								...
								?>
									...
									<tr>
										...
										<td><a href="donar/singledonar.php?id=<?php echo $result['donar_id']; ?>"><?php echo $result['donar_name'] ?></a></td>
