						...
						<div class="row">
							...
							<table class="table table-striped table-hover">
								...
								<tr>
									...
									<td><a href="singlemessage.php?id=<?php echo $result['id']; ?>"><?php echo $result['name'] ?></a></td>
									<td><?php echo $result['email'] ?></td>
									<td><?php echo $result['subject'] ?></td>
									<td><?php echo $result['message'] ?></td>
									<td>
										<a href="deletemessage.php?id=<?php echo $result['id']; ?>"><button class="btn btn-danger btn-sm">delete</button></a>
									</td>
								</tr>
								<?php } ?>
							</table>
