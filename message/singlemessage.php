			...
			<div class="container">
				...
				<nav id="nav">
					<ul class="main-menu nav navbar-nav navbar-right">
						<li><a href="../admin/adminindex.php">Home</a></li>
						...
						<div class="row container">
							...
							<table class="table">
								<?php while($result = mysqli_fetch_assoc($run)){ ?>
									...
									<h6>E-Mail: <?php echo $result['email'] ?></h6>
									<h6>Subject: <?php echo $result['subject'] ?></h6>
									<p style="border: 1;"><?php echo $result['message'] ?></p>
									<br><br>
									<a href="deletemessage.php"><button class="btn btn-danger btn-sm">delete</button></a>
								<?php } ?>
							</table>
						</div>
						<!-- /row -->
