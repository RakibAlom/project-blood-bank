...
<?php 
	...
	if(isset($_POST['login'])){
		...
		$sql = "SELECT * FROM blood_donator WHERE donar_phone = '$user' AND donar_password = '$password'";
		...
		if($check == true){
			echo "<script> 
				window.open('donar/donarindex.php','_self');
			</script>";
		}else{
			echo "<script> 
 ...
 ?>
					...
					<div id="aside" class="col-md-3">
						...
						<div class="widget tags-widget">
							<h3>Tags</h3>
							<a class="tag" name="searchdata" href="searchdetails.php">A(+)</a>
							<a class="tag" href="searchdetails.php">A(-)</a>
							<a class="tag" href="searchdetails.php">B(+)</a>
							<a class="tag" href="searchdetails.php">B(-)</a>
							<a class="tag" href="searchdetails.php">O(+)</a>
							<a class="tag" href="searchdetails.php">O(-)</a>
							<a class="tag" href="searchdetails.php">AB(+)</a>
							<a class="tag" href="searchdetails.php">AB(-)</a>
						</div>
						<!-- /tags widget -->
